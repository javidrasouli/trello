...
<div class="mt-5 flex">
  ...
  <button class="m-auto border p-2 rounded-xl bg-green-500 outline-none focus:outline-none transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">close</button>
</div>
</div>
